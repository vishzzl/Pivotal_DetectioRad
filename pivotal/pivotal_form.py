...
def new_patients():
    ...
    label_id.place(relx=0.194, rely=0.185, height=40, width=192)
    ...
    idEntry.place(relx=0.388, rely=0.185,height=40, relwidth=0.402)
    ...
    label_name.place(relx=0.194, rely=0.277, height=40, width=188)
    ...
    nameEntry.place(relx=0.388, rely=0.277,height=40, relwidth=0.402)
    ...
    label_age.place(relx=0.194, rely=0.369, height=40, width=188)
    ...
    ageEntry.place(relx=0.388, rely=0.369,height=40, relwidth=0.402)
    ...
    label_gender.place(relx=0.194, rely=0.461, height=40, width=188)
    ...
    genderEntry.place(relx=0.388, rely=0.461, height=40, relwidth=0.402)
    ...
    genderEntry.configure(highlightbackground="#808080")
    ...
    label_history.place(relx=0.194, rely=0.572, height=40, width=188)
    ...
    history_Entry.place(relx=0.388, rely=0.554, height=200, relwidth=0.410)
    ...
    label_xray.place(relx=0.184, rely=0.904, height=40, width=188)
    ...
    img = Button(Canvas1)
    img.place(relx=0.388, rely=0.923, height=40, width=145)
    ...
    submit.place(relx=0.602, rely=0.923, height=40, width=172)
    ...
    Label21.place(relx=0.524, rely=0.923, height=32, width=95)
...
def view_record():
    ...
    registration.place(relx=0.209, rely=0.24, height=40, width=162)    
    ...
    name_box.place(relx=0.209, rely=0.412, height=40, width=162)
...
def form_page():
    ...
    n_patients.place(relx=0.360, rely=0.314, height=65, width=400)
    ...
    o_patients_1.place(relx=0.360, rely=0.517, height=65, width=400)
    ...
    Label2.place(relx=0.336, rely=0.207, height=50, width=150)
    ...
    Button1.place(relx=0.783, rely=0.207, height=40, width=95)
    Button1.configure(activebackground="#ececec")
    Button1.configure(activeforeground="#000000")
